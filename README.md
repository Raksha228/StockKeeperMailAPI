...
**Разработка корпоративного приложения для инвентаризации складских запасов продаваемых товаров и внутренней электронной почты для ИП Бахолдина**
...
- регистрация прихода товара от поставщика на выбранный склад
- учет номера документа поставщика, количества, закупочной цены, суммы прихода и комментария
...
- учет внешнего номера заказа (`ExternalOrderNumber`)
- признак онлайн-заказа (`IsOnlineOrder`)
- хранение адреса доставки (`DeliveryAddress`)
- печать счета с учетом данных заказа
...
- фильтрация статистики заказов по периоду: день, месяц, год и весь период
