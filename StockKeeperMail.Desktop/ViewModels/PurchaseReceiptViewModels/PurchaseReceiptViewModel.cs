...
namespace StockKeeperMail.Desktop.ViewModels
{
    ...
    public class PurchaseReceiptViewModel : ViewModelBase
    {
        ...
        public string PurchaseReceiptID => _purchaseReceipt.PurchaseReceiptID.ToString();
        public string DocumentNumber => string.IsNullOrWhiteSpace(_purchaseReceipt.DocumentNumber) ? "—" : _purchaseReceipt.DocumentNumber;
        public string Quantity => _purchaseReceipt.Quantity.ToString("N0", _ruCulture);
        public string UnitPrice => _purchaseReceipt.UnitPrice.ToString("N2", _ruCulture);
        public string TotalAmount => _purchaseReceipt.TotalAmount.ToString("N2", _ruCulture);
        public string PurchasedAt => _purchaseReceipt.PurchasedAt.ToString("dd.MM.yyyy HH:mm", _ruCulture);
